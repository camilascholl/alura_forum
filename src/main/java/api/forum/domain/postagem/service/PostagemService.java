package api.forum.domain.postagem.service;

import api.forum.domain.ValidacaoException;
import api.forum.domain.postagem.DadosDetalhamentoPostagem;
import api.forum.domain.postagem.DadosPostagem;
import api.forum.domain.postagem.Postagem;
import api.forum.domain.postagem.dto.DadosPostagemDTO;
import api.forum.domain.postagem.validation.ValidadorPostagem;
import api.forum.domain.usuario.AuthenticationLogin;
import api.forum.domain.usuario.Usuario;
import api.forum.repository.PostagemRepository;
import api.forum.repository.UsuarioRepository;
